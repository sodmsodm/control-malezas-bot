...
def pee_trigo_raigras_nacida():
    return (
        ...
        "✅ Pinoxaden (Axial) 0,6-0,8 L/ha + aceite mineral\n"
        "   ACCasa — control más lento que paraquat\n"
        "   ⚠️ Uso off-label (sin respaldo de marbete en PEE). Consultar con Ingeniero Agrónomo antes de aplicar.\n\n"
